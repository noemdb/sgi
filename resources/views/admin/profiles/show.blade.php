                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="btn-group d-flex pt-2" style="width: 100%;" role="group" aria-label="Basic example">
                              ...
                              <a class="btn btn-dark w-100" href="{{ isset($profile->id) ? route('profiles.edit',$profile->id) : route('profiles.create')}}" role="button">    
                                {{ isset($profile->id) ? 'Actualizar' : 'Crear'}}
                                <i class="fas fa-id-card"></i> 
                              </a>

                              <a class="btn btn-secondary w-100" href="{{ route('users.edit',$user->id) }}" role="button">
                                Actualizar
