...
@section('main')
    ...
    <main role="main" class="col-md-10 ml-sm-auto col-lg-10">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3>
                    Listados de Frecuencias registrados<br>
    ...
    {!! Form::open(['route' => ['afrecuencias.destroy',':AFRECUENCIA_ID'], 'method' => 'DELETE', 'id'=>'form-delete', 'role'=>'form']) !!}
    {!! Form::close() !!}
...
@section('scripts')
    ...
    <script src="{{ asset("js/models/poa/mactividads/afrecuencias/delete.js") }}"></script>
