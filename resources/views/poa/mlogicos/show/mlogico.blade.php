@isset($mlogico)
    ...
    <table class="table table-striped table-bordered {{-- table-sm table-hover --}}">
      <tbody>
        <tr>
            <th scope="col">Descripción POA</th>

            <th scope="col">

                <span class="text-mlogicos-descripcion-{{ $mlogico->id  or ''}}">
                    {{ $mlogico->poa->descripcion or ''}}
                </span>
        ...
        <tr>
            <td colspan="2">
                <div class="btn-group d-flex pt-2" style="width: 100%;" role="group" aria-label="Basic example">
                  <a class="btn btn-active w-100" href="{{ route('mlogicos.edit',$mlogico->id) }}" role="button">
                    Actualzar
