...
@section('main')
    ...
    {!! Form::open(['route' => ['mproblemas.destroy',':MPROBLEMA_ID'], 'method' => 'DELETE', 'id'=>'form-delete', 'role'=>'form']) !!}
    {!! Form::close() !!}
...
@section('scripts')
    ...
    <script src="{{ asset("js/models/poa/mproblemas/mproblemas/delete.js") }}"></script>
