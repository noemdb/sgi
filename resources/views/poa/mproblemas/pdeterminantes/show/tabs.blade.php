<ul class="nav nav-tabs" id="myTab" role="tablist">
  ...
  <li class="nav-item">
    <a class="nav-link" id="pdeterminantes-tab" data-toggle="tab" href="#pdeterminantes" role="tab" aria-controls="pdeterminantes" aria-selected="false" title="Matriz de Problemas">Problemas</a>
  </li>
  <li class="nav-item">
