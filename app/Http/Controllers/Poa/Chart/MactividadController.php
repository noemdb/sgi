...
class MactividadController extends Controller
{
    ...
    {        
        return view('poa.mactividads.actividads.charts');
    }
    ...
    public function ActivResp(Request $request)
	{
        ...
        // dd($mactividads->toarray(),$labels , $responsable_id);
		...
		// dd($activ_iniciadas,$activ_finalizadas,$activ_reprogramadas,$activ_asignadas);
