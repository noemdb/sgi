...
class ProfileController extends Controller
{
    ...
    */
    ...
    public function show($id)
    {
        ...
        $rols = Rol::Where('user_id',$profile->user_id)->get();

        return view('admin.profiles.show',compact('profile','user','rols'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.profiles.edit',compact('profile','user','rols'));
    }
